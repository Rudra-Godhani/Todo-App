...
import { Plus, Download, Dumbbell, Loader2, Edit, Trash } from "lucide-react"
  ...
  const handleExport = () => {
    if (workouts.length === 0) {
      toast({
        ...
        description: "There are no workouts to export.",
        variant: "default",
      })
      return
    }
    exportToCSV(workouts, "fittracker_workouts.csv")
    toast({
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {workouts.length === 0 ? (
        <EmptyState
          ...
          description="It looks like you haven't logged any workouts. Start your fitness journey now!"
          action={{ label: "Add Your First Workout", onClick: () => router.push("/workouts/add") }}
        ...
        <Card className="animate-in fade-in-0 slide-in-from-bottom-4 duration-700">
          <CardHeader>
            ...
            <CardDescription>A comprehensive list of your logged workouts.</CardDescription>
          </CardHeader>
          <CardContent>
